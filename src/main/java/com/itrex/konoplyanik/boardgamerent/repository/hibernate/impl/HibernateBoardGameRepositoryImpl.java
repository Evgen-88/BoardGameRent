...
import com.itrex.konoplyanik.boardgamerent.repository.hibernate.HibernateBoardGameRepository;

@Deprecated
@Repository
public class HibernateBoardGameRepositoryImpl implements HibernateBoardGameRepository {
	...
	public HibernateBoardGameRepositoryImpl(SessionFactory sessionFactory) {
