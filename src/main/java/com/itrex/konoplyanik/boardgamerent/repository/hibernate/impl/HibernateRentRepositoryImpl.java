...
import com.itrex.konoplyanik.boardgamerent.repository.hibernate.HibernateRentRepository;

@Deprecated
@Repository
public class HibernateRentRepositoryImpl implements HibernateRentRepository {
	...
	public HibernateRentRepositoryImpl(SessionFactory sessionFactory) {
