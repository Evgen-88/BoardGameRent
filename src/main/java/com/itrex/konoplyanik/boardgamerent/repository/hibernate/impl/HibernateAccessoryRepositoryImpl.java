...
import com.itrex.konoplyanik.boardgamerent.repository.hibernate.HibernateAccessoryRepository;

@Deprecated
@Repository
public class HibernateAccessoryRepositoryImpl implements HibernateAccessoryRepository {
	...
	public HibernateAccessoryRepositoryImpl(SessionFactory sessionFactory) {
