...
public class UserReportController {
    ...
    @GetMapping
    public ResponseEntity<List<UserReportDTO>> getUserReport(
        ...
        List<UserReportDTO> userReports = null;
        try {
            userReports = reportService.getUserReport(startFrom, endTo, setPageParameters(page, size, sortBy, sortDirection));
        } catch (ServiceException ex) {
            new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
        return userReports != null ? new ResponseEntity<>(userReports, HttpStatus.OK) : new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }
