...
public class JDBCPurchaseRepositoryImplTest extends BaseRepositoryTest {
	private final PurchaseRepository repository;
	private List<Purchase> purchases;
	
	public JDBCPurchaseRepositoryImplTest() {
		super();
		repository = new JDBCPurchaseRepositoryImpl(getConnectionPool());
