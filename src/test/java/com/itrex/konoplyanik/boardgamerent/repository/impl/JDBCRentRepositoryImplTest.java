...
public class JDBCRentRepositoryImplTest extends BaseRepositoryTest {
	...
	public void update_validData_shouldUpdateRent() {
		...
		Rent expected = new Rent(1L, 4L, 4L, LocalDate.of(2021, 10, 24), LocalDate.of(2021, 10, 25), 50);
		//when
		rent.setBoardGameId(4L);
		rent.setOrderId(4L);
		rent.setFrom(LocalDate.of(2021, 10, 24));
		rent.setTo(LocalDate.of(2021, 10, 25));
		rent.setPrice(50);
