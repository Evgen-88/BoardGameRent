...
public class JDBCBoardGameRepositoryImplTest extends BaseRepositoryTest {
	private final BoardGameRepository repository;
	private List<BoardGame> boardGames;
	
	public JDBCBoardGameRepositoryImplTest() {
		super();
		repository = new JDBCBoardGameRepositoryImpl(getConnectionPool());
