...
public class HibernateBoardGameRepositoryImplTest extends BaseRepositoryTest {
	private final BoardGameRepository repository;
	private List<BoardGame> boardGames;

	public HibernateBoardGameRepositoryImplTest() {
		super();
		repository = new HibernateBoardGameRepositoryImpl(getSessionFactory().openSession());
	}
