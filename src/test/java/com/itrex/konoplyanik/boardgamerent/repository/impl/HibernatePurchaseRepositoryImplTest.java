...
public class HibernatePurchaseRepositoryImplTest extends BaseRepositoryTest {
	private final PurchaseRepository repository;
	private List<Purchase> purchases;

	public HibernatePurchaseRepositoryImplTest() {
		super();
		repository = new HibernatePurchaseRepositoryImpl(getSessionFactory().openSession());
	}
	...
	public void update_validData_shouldUpdatePurchase() {
		...
		//when
		purchase.setAccessoryId(2L);
		purchase.setOrderId(3L);
